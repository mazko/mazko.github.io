...
public class TestUAX29URLEmailTokenizer extends BaseTokenStreamTestCase {
	...
	public void testLongEMAILatomText() throws Exception {
		...
		char[] emailAtomChars = "!#$%&'*+,-./0123456789=?ABCDEFGHIJKLMNOPQRSTUVWXYZ^_`abcdefghijklmnopqrstuvwxyz{|}~"
				.toCharArray();
	...
	public void testMailtoSchemeEmails() throws Exception {
		...
		BaseTokenStreamTestCase.assertAnalyzesTo(a, "mailto:test@example.org",
				new String[] { "mailto", "test@example.org" }, new String[] { "<ALPHANUM>", "<EMAIL>" });
		...
		BaseTokenStreamTestCase.assertAnalyzesTo(a,
				...
				new String[] { "mailto", "personA@example.com",
						...
						",personB@example.com", "?cc=personC@example.com", // TODO:
																			...
																			// field
																			// keys/values
						"subject", "Subjectivity", "body", "Corpusivity", "20or", "20something", "20like", "20that" }, // TODO:
																														// Hex
																														// decoding
																														// +
																														// re-tokenization
				new String[] { "<ALPHANUM>", "<EMAIL>", "<EMAIL>", "<EMAIL>", "<ALPHANUM>", "<ALPHANUM>", "<ALPHANUM>",
