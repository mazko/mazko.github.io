...
Очевидно, что такой *TDD* подход на порядок удобнее [предыдущих]({filename}../2012-10-07-manchester-code-for-dummies/2012-10-07-manchester-code-for-dummies.md). Тут очень многое зависит от возможностей эмулятора и иногда функционала *sim30* бывает недостаточно. Типичный пример - логика обработка прерываний:
